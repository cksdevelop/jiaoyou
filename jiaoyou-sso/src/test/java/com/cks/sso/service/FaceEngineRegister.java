...
public class FaceEngineRegister {


    public static void main(String[] args) {

        //从官网获取
        String appId = "H1EvaMCfxZccGzhWUZpqD1g6gHmZFn5PVK47cxxwmLsr";
        String sdkKey = "EiWdjFdSjetccRE4FGxE7Q4vYhMpu4nSBAoYDrX8VN3Z";


        FaceEngine faceEngine = new FaceEngine("D:\\TestSource\\ArcSoft_ArcFace_Java_Windows_x64_V3.0\\libs\\WIN64");
        //激活引擎
